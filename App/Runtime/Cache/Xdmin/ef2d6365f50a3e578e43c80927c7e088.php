...
<body class="hold-transition skin-blue sidebar-mini">
                  ...
                  <div class="search-box">
					  <form class="form-inline" action="" method="get">
						...
						<div class="input-group" style="width: 150px;">
						  <input type="text" name="keyword" class="form-control input-sm pull-right" placeholder="输入标题">
				...
				<form id="form" action="<?php echo U('del');?>" method="post">
					<div class="box-body table-responsive no-padding">
					  <table class="table table-hover">
						...
						<?php if(is_array($banner)): $i = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
							<td class="center">
								<input class="lids" type="checkbox" name="id[]" value="<?php echo ($val['id']); ?>">
							</td>
							<td><?php echo ($val['rank']); ?></td>
							<td><img src="/Public/upload/image/<?php echo ($val['img']); ?>" height="30" width="150" /></td>
	...
	<script>
		$('#pBanner').addClass("active").siblings().removeClass("active");
		$('#iBanner').addClass("active");
